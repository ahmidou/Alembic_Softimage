...
typedef ICEAttributeDataArrayConverter<XSI::MATH::CRotationf, AbcFramework::VRotationfTraits> ICEAttributeDataArrayRotationfConverter;
...
typedef ICEAttributeDataArrayConverter<XSI::MATH::CVector4f,  AbcFramework::V4fTPTraits> ICEAttributeDataArrayVec4fConverter;
