...
bool CAbcUtils::IsValidGeomParam( IAbcIPropertyAccessor* in_pOProp, IAbcIGeomParam** out_ppGeomParam ) const
{
	if ( CAbcIPropertyFactory::WrapIGeomParam( out_ppGeomParam, in_pOProp ) == EResult_Success )
	{
		return true;
	}
