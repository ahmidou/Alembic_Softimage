...
#define PROPNAME_INDICES				"indices"
...
public:
	...
	*/
	...
	/*! Test if an IAbcIPropertyAccessor is a valid IGeomParam
	\param in_pIProp The input property
	\param out_ppGeomParam The pointer to hold the geom param
	\return True if the property is a valid Array2D
	*/
	virtual bool IsValidGeomParam( IAbcIPropertyAccessor* in_pOProp, IAbcIGeomParam** out_ppGeomParam ) const = 0;
};
